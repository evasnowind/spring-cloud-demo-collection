package com.prayerlaputa.dataredis;
...
public class StandaloneRedisTest {
    ...
    @Test
    public void testTransactionAndWatch() {
        jedis.flushDB();
        jedis.watch("collections");
        Transaction transaction = jedis.multi();
        transaction.set("collections", "testval");
        transaction.set("abc", "abcval");
        System.out.println(transaction.get("collections"));
